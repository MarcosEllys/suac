...
class Createpeople extends Migration {
	...
	public function up()
	{
		Schema::create('peoplesreferences',function(Blueprint $table){	
			...
			$table->string('nomemae',60)
			->nullable()
			->default(null);

			$table->string('nomepai',60)
			->nullable()
			->default(null);
			...
			$table->integer('numeroprontuario');

			$table->string('tipounidade',5);

			$table->string('nomeunidade',20);
			 ...
			 */
			 ...
			 $table->string('pointreference',20)
			 ->nullable()
			 ->default(null);
